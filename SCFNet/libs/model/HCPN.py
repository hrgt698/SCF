...
class EncoderNet(nn.Module):
    ...
    # f1: image1 f2: image2 f3: middle image/flow
...
#         # mask1
#         c5_1 = self.bdry5(h5_1) #[1,16,16]
#         c4_1 = self.bdry4(h4_1) #[1,32,32]
#         c3_1 = self.bdry3(h3_1) #[1,64,64]
#         c2_1 = self.bdry2(h2_1) #[1,128,128]
...
#         concat_1 = torch.cat([c2_up_1, c3_up_1, c4_up_1, c5_up_1], dim=1) #[4,512,512]
#         c_1 = self.concat(concat_1) #[1,512,512]
...
#         x = self.GC(x) #[256,16,16]
#         r = self.convG1(F.relu(x))
#         r = self.convG2(F.relu(r))
#         m5 = x + r #[256,16,16]
#         m4 = self.RF4(r4, m5) #[256,32,32]
#         m3 = self.RF3(r3, m4) #[256,64,64]
#         m2 = self.RF2(r2, m3) ##[256,128,128]

#         p2 = self.pred2(F.relu(m2)) #[1,128,128]
