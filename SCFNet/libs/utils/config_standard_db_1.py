...
__C.PATH.ROOT = osp.abspath('/users/u202220081200014/video-inpainting/video_forgery/SCFNet_2.0')

# Data folder
__C.PATH.DATA = osp.abspath('/groups/imageNSFC/home/u202220081200014/share/videoDataset/VideoSplicingDataset2.0')
