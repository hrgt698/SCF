...
if __name__ == '__main__':
    ...
    args.model_name = 'SCFNet_VSD2.0_Ablation_no_coattentionfusion'
    args.result_path=r'/users/u202220081200014/video-inpainting/video_forgery/SCFNet_2.0/results'
    args.batch_size = 10
    args.ngpus = 1
    args.max_epoch = 6
    args.resume=False
