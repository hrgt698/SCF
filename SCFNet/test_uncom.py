       ...
       # flowfiles = sorted(glob.glob(os.path.join(flow_dir, '*.png')))
        ...
        with torch.no_grad():
            for index in range(0,min(len(imagefiles),len(maskfiles))):
                ...
                mask1 = cv2.imread(maskfiles[index][0], 0)
                mask2 = cv2.imread(maskfiles[index][2], 0)
...
def randomTest():
    ...
    encoder.train(False)
    decoder.train(False)
    im1 = np.random.random((512, 512, 3))
...
if __name__ == '__main__':
    ...
    model_path = r'/users/u202220081200014/video-inpainting/video_forgery/HCPN_MLP/results/HCPN_MLP'
    epoch = 18

    #test_set = r'/groups/imageNSFC/home/u202220081200014/share/videoDataset/video-splice/sub_dataset/val/videos'
    video_dir = r'/groups/imageNSFC/home/u202220081200014/share/videoDataset/splicing-Avino2017/complete_object/complete_object/videos'
    #davis_flow_dir = '/Your_PathDAVIS/DAVIS/davis-flow'

    mask_dir = r'/groups/imageNSFC/home/u202220081200014/share/videoDataset/splicing-Avino2017/complete_object/complete_object/masks'
    mask_result_dir= r'/groups/imageNSFC/home/u202220081200014/share/videoDataset/splicing-Avino2017/complete_object/complete_object/masks_MLP_e18_uncom_pred'
